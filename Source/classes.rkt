  ...
  (define (dispatch op)
    (cond ((eq? op 'get_pos) (cons pos_x pos_y))
          ...
          ((eq? op 'move) (begin
                          ...
                          (if (< pos_y bottom_bound) (set! vel_y (+ vel_y 2)) (set! vel_y 0))) ;gravity
...
(define ball (make_object (/ windowXbound 4) (/ windowYbound 4) 0 0 18 0 windowXbound (- windowYbound 36)))
...
(define Slime1 (make_object (/ windowXbound 4) (- windowYbound 200) 0 0 78 0 (- (/ windowXbound 2) 138) slimebot))
(define Slime2 (make_object (* 3(/ windowXbound 4)) windowYbound 0 0 78 (+ (/ windowXbound 2) 2) (- windowXbound 136) slimebot))