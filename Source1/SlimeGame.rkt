    ...
    (define/override (on-char event)(begin
      ...
      (cond
        ...
        [(eq? (send event get-key-code) 'up)
         (if (= (- windowYbound 68) (cdr (Slime1 'get_pos))) ((Slime1 'set_vel) (car (Slime1 'get_vel)) -25) (values))]
        ...
        [(eq? (send event get-key-code) #\w)
         (if (= (- windowYbound 68) (cdr (Slime2 'get_pos))) ((Slime2 'set_vel) (car (Slime2 'get_vel)) -25) (values))]
